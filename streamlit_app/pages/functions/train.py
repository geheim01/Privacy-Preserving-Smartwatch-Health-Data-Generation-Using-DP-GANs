...
# from synthesizers.regular import RegularSynthesizer
# from synthesizers.timeseries import TimeGAN

# __MODEL_MAPPING = {"timeseries": TimeGAN}
...
# def init_synth(
#     datatype: str, modelname: str, model_parameters: ModelParameters, n_critic: int = 1
# ):
#     synth = __MODEL_MAPPING[datatype]
#     modelname = modelname.lower()
#     if modelname in ["wgan", "cwgangp", "wgangp"]:
#         synth = synth(
#             modelname=modelname, model_parameters=model_parameters, n_critic=n_critic
#         )
#     else:
#         synth = synth(modelname=modelname, model_parameters=model_parameters)
#     return synth
